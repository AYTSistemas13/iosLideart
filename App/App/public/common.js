...
/***/ 17571:
/*!***********************************************************!*\
  !*** ./src/app/pages/modal-product/modal-product.page.ts ***!
  \***********************************************************/
...
/* harmony export */   ModalProductPage: () => (/* binding */ ModalProductPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 42321);
/* harmony import */ var _modal_product_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal-product.page.html?ngResource */ 71217);
/* harmony import */ var _modal_product_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal-product.page.scss?ngResource */ 60980);
/* harmony import */ var _modal_product_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modal_product_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__);
...
let ModalProductPage = class ModalProductPage {
  ...
  ngOnInit() {
    this.imageModal = this.url + this.product.image_link;
  }
  closeModal() {
    this.modalController.dismiss();
  }
  openRefund() {
    window.open(this.url + '/content/6-politica-de-reembolso');
  }
  openDetails() {
    window.open(this.url + "/" + this.product.link);
  }
...
ModalProductPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
  selector: 'app-modal-product',
  template: _modal_product_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
  styles: [(_modal_product_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1___default())]
})], ModalProductPage);
...
/***/ 46943:
/*!******************************************************!*\
  !*** ./src/app/services/checkout-service.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CheckoutServiceService: () => (/* binding */ CheckoutServiceService)
/* harmony export */ });
...
let CheckoutServiceService = class CheckoutServiceService {
  constructor(http) {
    this.http = http;
    this.apiUrl = 'https://lideart.aytcloud.com/inaxapiv2/api/venta';
    this.url = this.apiUrl + '';
  }
  getDireccion(correo) {
    return this.http.get('https://lideart.com.mx/Automatizacion/apis/getDireccion.php?email=' + correo);
  }
  registraCarrito(datos = []) {
    return this.http.post('https://lideart.com.mx/Automatizacion/apis/registraCarrito.php', datos);
  }
  webpay(datosPay = []) {
    return this.http.post('https://lideart.com.mx/Automatizacion/apis/webpay.php', datosPay);
  }
  checaPago(carrito) {
    return this.http.get('https://avanceytec.com.mx/Automatizacion/apis/checaPagoWebPayLideapp.php?carrito=' + carrito);
  }
  addCotizacionDynamics(cotizacion) {
    return this.http.post("https://lideart.aytcloud.com/inaxapiv2/api/ecommerce/addCotizacionDynamics", cotizacion, httpOption).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError));
  }
  mandaMensaje(cotizacion) {
    return this.http.post("https://lideart.aytcloud.com/inaxLideartExpoConsAPI/api/email/contactoLideart", cotizacion);
  }
  mandacorreo(cotizacion) {
    return this.http.post("https://lideart.aytcloud.com/inaxapilideart/api/email/emailConfirmacionOV", cotizacion);
  }
  handleError(error) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(error.message || "Server Error");
  }
  convertirOrdenVenta(parametros) {
    return this.http.post("https://lideart.aytcloud.com/inaxLideartExpoConsAPI/api/venta/convertirOrdenVenta", parametros, httpOption).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError));
  }
  guarda_venta(datosCorreo) {
    return this.http.post('https://lideart.com.mx/Automatizacion/apis/guardaVenta.php', datosCorreo);
  }
  guardaObjetoCot(objetoCot = [], email) {
    return this.http.post('https://lideart.com.mx/Automatizacion/apis/registraObjCot.php', {
      objetoCot,
      email
    });
  }
...
CheckoutServiceService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
  providedIn: 'root'
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_eduardoacosta_Documents_GitHub_LideartApp_IONIC_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_eduardoacosta_Documents_GitHub_LideartApp_IONIC_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_eduardoacosta_Documents_GitHub_LideartApp_IONIC_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 60980:
/*!************************************************************************!*\
  !*** ./src/app/pages/modal-product/modal-product.page.scss?ngResource ***!
  \************************************************************************/
...
.quantity {
  width: 80%;
}`, "",{"version":3,"sources":["webpack://./src/app/pages/modal-product/modal-product.page.scss"],"names":[],"mappings":"AAAA;EACE,eAAA;EACA,gBAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;AACF;;AAEA;EACE,mBAAA;EACA,gBAAA;EACA,kBAAA;EACA,mBAAA;AACF;;AAEA;EACE,kBAAA;EACA,WAAA;AACF;;AACA;EACE,UAAA;AAEF;;AACA;EACE,qBAAA;EACA,YAAA;EACA,WAAA;EACA,iBAAA;EACA,gBAAA;EACA,WAAA;EACA,gBAAA;AAEF;;AACA;EACE,iBAAA;AAEF;;AACA;EACE,aAAA;EACA,mBAAA;EACA,eAAA;EACA,oBAAA;EACA,qBAAA;EACA,yBAAA;EACA,8BAAA;AAEF;;AACA;EACE,mBAAA;EACA,mBAAA;EACA,aAAA;AAEF;;AACA;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,mBAAA;AAEF;AADE;EACE,SAAA;AAGJ;;AACA;EACE,kBAAA;EACA,mBAAA;EACA,SAAA;EACA,sBAAA;EACA,mBAAA;AAEF;;AACA;EACE,cAAA;EACA,uBAAA;EACA,eAAA;EACA,qBAAA;EACA,wBAAA;EACA,aAAA;AAEF;;AACA;EACE,eAAA;AAEF;;AACA;EACE,kBAAA;EACA,WAAA;EACA,cAAA;EACA,yBAAA;AAEF;;AACA;EACE,UAAA;AAEF","sourcesContent":["ion-label {\n  margin-top: 1em;\n  margin-left: 1em;\n}\n\n.productContainer {\n  display: flex;\n  flex-direction: column;\n}\n\n.modal-title {\n  font-weight: bolder;\n  font-size: large;\n  margin-bottom: 1em;\n  letter-spacing: 1px;\n}\n\n.add-to-cart {\n  margin: 0 0 0 10px;\n  color: #fff;\n}\n.add-to-cart-button {\n  width: 50%;\n}\n\n.item-product {\n  display: inline-block;\n  height: 35px;\n  float: left;\n  margin-right: 5px;\n  padding-top: 5px;\n  width: 35px;\n  margin-left: 2em;\n}\n\n.block-title {\n  line-height: 40px;\n}\n\n.modal-specs {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  align-items: stretch;\n  margin: 2em 1em 0 1em;\n  align-content: flex-start;\n  justify-content: space-between;\n}\n\n.modal-price {\n  font-weight: bolder;\n  font-size: xx-large;\n  margin-top: 0;\n}\n\n.specs {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  align-items: center;\n  ion-label {\n    margin: 0;\n  }\n}\n\n.input-group-btn-vertical {\n  position: relative;\n  white-space: nowrap;\n  width: 1%;\n  vertical-align: middle;\n  display: table-cell;\n}\n\n.product-quantity #quantity_wanted {\n  color: #333333;\n  background-color: white;\n  height: 2.75rem;\n  z-index: 0 !important;\n  padding: 0.175rem 0.5rem;\n  width: 3.9rem;\n}\n\n.input-group-addon:not(:last-child) {\n  border-right: 0;\n}\n\n.input-group {\n  position: relative;\n  width: 100%;\n  display: table;\n  border-collapse: separate;\n}\n\n.quantity {\n  width: 80%;\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ 71217:
/*!************************************************************************!*\
  !*** ./src/app/pages/modal-product/modal-product.page.html?ngResource ***!
  \************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-title color=\"light\" mode=\"md\">Productos Lideart</ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-icon\n        (click)=\"closeModal()\"\n        name=\"close-circle\"\n        color=\"light\"\n      ></ion-icon>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"productContainer\">\n    <ion-label color=\"dark\" class=\"modal-title\"> {{product.nombre}} </ion-label>\n    <img src=\"{{imageModal}}\" alt=\"img_product\" />\n    <ion-label color=\"dark\" style=\"font-weight: 400; font-size: small\">\n      Código de Producto: {{product.sku[0]}}\n    </ion-label>\n    <ion-label color=\"dark\" class=\"modal-title\"> Color: </ion-label>\n    <ion-label color=\"dark\" class=\"modal-price\">\n      ${{product.precio | number:'1.2-2'}}\n    </ion-label>\n    <div class=\"modal-specs\">\n      <ion-button\n        expand=\"block\"\n        slot=\"end\"\n        color=\"primary\"\n        class=\"add-to-cart-button\"\n      >\n        <ion-icon name=\"bag-add\"></ion-icon>\n        <ion-label class=\"add-to-cart\"> Añadir al carrito </ion-label>\n      </ion-button>\n      <div class=\"specs\" style=\"width: 30%; margin-left: 2em\">\n        <ion-label color=\"dark\" style=\"margin-top: 0\">Cantidad</ion-label>\n        <ion-item class=\"quantity\">\n          <ion-input type=\"number\"></ion-input>\n        </ion-item>\n      </div>\n      <div class=\"specs\" style=\"margin-top: 10px\">\n        <ion-label color=\"dark\">Color</ion-label>\n        <ion-item>\n          <ion-select interface=\"popover\">\n            <ion-select-option value=\"Rojo\">Rojo</ion-select-option>\n            <ion-select-option value=\"Gris\">Gris</ion-select-option>\n            <ion-select-option value=\"Verde\">Verde</ion-select-option>\n            <ion-select-option value=\"Azul\">Azul</ion-select-option>\n            <ion-select-option value=\"saturn\">Morado</ion-select-option>\n            <ion-select-option value=\"snes\">Negro</ion-select-option>\n          </ion-select>\n        </ion-item>\n      </div>\n      <ion-button\n        expand=\"block\"\n        slot=\"end\"\n        color=\"primary\"\n        class=\"add-to-cart-button\"\n        (click)=\"openDetails()\"\n      >\n        <ion-icon name=\"eye\"></ion-icon>\n        <ion-label class=\"add-to-cart\"> Ver detalles </ion-label>\n      </ion-button>\n    </div>\n  </div>\n  <div class=\"blockreassurance_product\">\n    <div>\n      <ion-icon name=\"shield-checkmark\" class=\"item-product\"></ion-icon>\n      <p class=\"block-title\" style=\"color: #000000\">Tu compra está protegida</p>\n    </div>\n    <div>\n      <ion-icon name=\"send\" class=\"item-product\"></ion-icon>\n      <p class=\"block-title\" style=\"color: #000000\">\n        Envíos a toda la república mexicana\n      </p>\n    </div>\n    <div (click)=\"openRefund()\">\n      <ion-icon name=\"swap-horizontal\" class=\"item-product\"></ion-icon>\n      <p class=\"block-title\" style=\"color: #000000\">Política de reembolso</p>\n    </div>\n    <div class=\"clearfix\"></div>\n  </div>\n</ion-content>\n";
