(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_pages_modal-descripcion-paquetes_modal-descripcion-paquetes_page_ts"],{

/***/ 84081:
/*!*************************************************************************************!*\
  !*** ./src/app/pages/modal-descripcion-paquetes/modal-descripcion-paquetes.page.ts ***!
  \*************************************************************************************/
...
/* harmony export */   ModalDescripcionPaquetesPage: () => (/* binding */ ModalDescripcionPaquetesPage)
/* harmony export */ });
...
/* harmony import */ var _modal_descripcion_paquetes_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal-descripcion-paquetes.page.html?ngResource */ 61171);
/* harmony import */ var _modal_descripcion_paquetes_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modal-descripcion-paquetes.page.scss?ngResource */ 45511);
/* harmony import */ var _modal_descripcion_paquetes_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modal_descripcion_paquetes_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
...
let ModalDescripcionPaquetesPage = class ModalDescripcionPaquetesPage {
...
ModalDescripcionPaquetesPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-modal-descripcion-paquetes',
  template: _modal_descripcion_paquetes_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_modal_descripcion_paquetes_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
})], ModalDescripcionPaquetesPage);

/***/ }),

/***/ 45511:
/*!**************************************************************************************************!*\
  !*** ./src/app/pages/modal-descripcion-paquetes/modal-descripcion-paquetes.page.scss?ngResource ***!
  \**************************************************************************************************/
...
.contiene-descripcion > table > tbody > tr > td > div > img {
  max-width: 100%;
  height: auto;
}`, "",{"version":3,"sources":["webpack://./src/app/pages/modal-descripcion-paquetes/modal-descripcion-paquetes.page.scss"],"names":[],"mappings":"AAAA;EACI,uBAAA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AACN;;AAEE;EACI,sCAAA;EACA,kCAAA;UAAA,0BAAA;EACA;uHAAA;EAEA,aAAA;EACA,8BAAA;EAEA,sBAAA;EAGA,WAAA;EACA,YAAA;EACA,sBAAA;EACA,aAAA;EAEA,2BAAA;EACA,qCAAA;EACA,mBAAA;EACA,yCAAA;EACA,0BAAA;EACA,kCAAA;EACA,wCAAA;AAHN;AAKM;EACE,WAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,aAAA;AAHR;AAKQ;EACE,UAAA;EACA,YAAA;AAHV;AAOM;EACE,WAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,iBAAA;AALR;AAMQ;EACE,WAAA;EACA,eAAA;EACA,kBAAA;EACA,mBAAA;AAJV;;AAcI;EACI,eAAA;EACA,mBAAA;EACA,YAAA;EACA,iBAAA;AAXR;;AAcI;EAED,kBAAA;AAZH;;AAeI;EACE,qBAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,uBAAA;EACA,cAAA;AAZN;;AAcI;EACE,YAAA;EACA,gBAAA;AAXN;;AAcI;EACE,yBAAA;AAXN;;AAcI;EACE,WAAA;EACA,sBAAA;EACA,kBAAA;EACA,YAAA;EACA,QAAA;EACA,SAAA;EACA,iDAAA;EACA,cAAA;AAXN;;AAcI;EACE,WAAA;EACA,YAAA;EACA,QAAA;EACA,SAAA;AAXN;;AAcI;EACE,eAAA;EACA,YAAA;AAXN","sourcesContent":["ion-content{\n    background-color: white;\n      display: flex;\n      justify-content: center;\n      align-items: center;\n  }\n  \n  ion-card{\n      background: rgba(255, 255, 255, 0.164); //     #fdfdfd            #14A8CD*\n      backdrop-filter: blur(2px);\n      /*background: rgb(28,138,242);\n      background: linear-gradient(0deg, rgba(28,138,242,1) 47%, rgba(45,166,253,1) 47%); //     #fdfdfd            #14A8CD*/\n      display: flex;\n      justify-content:space-between;\n     \n      flex-direction: column;\n      //box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;\n      //box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;\n      width: 100%;\n      height: 100%;\n      border-radius: .25rem;\n      padding: 1rem;\n  \n      /* From https://css.glass */\n      background: rgba(255, 255, 255, 0.150);\n      border-radius: 10px;\n      box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);\n      backdrop-filter: blur(3px);\n      -webkit-backdrop-filter: blur(3px);\n      border: .5px solid rgba(0, 0, 0, 0.082);\n  \n      .contImg{\n        width: 100%;\n        height: 60%;\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        padding: 1rem;\n  \n        img{\n          width: 80%;\n          height: auto;\n        }\n      }\n  \n      .text{\n        width: 100%;\n        height: 40%;\n        color: black;\n        font-size: 15px;\n        font-weight: bold;\n        ion-text{\n          width: 100%;\n          font-size: 20vw;\n          text-align: center;\n          color: rgb(0, 0, 0);\n          // text-shadow: 4px 3px 4px rgb(65, 64, 64); \n        }\n  \n      }\n  \n  \n  \n    }\n  \n    .textillo{\n        font-size: 20px;\n        margin-bottom: 10px;\n        color: black;\n        font-weight: bold;\n    }\n  \n    .form-group{\n  \n   margin-left: 100px;\n    }\n\n    .selector-color {\n      display: inline-block;\n      margin: 0px 2px;\n      width: 40px;\n      height: 40px;\n      position: relative;\n      border-radius: 3px;\n      cursor: pointer;\n      overflow: hidden;\n      transform: rotate(0deg);\n      transition: 1s;\n    }\n    .texto-descripcion {\n      color: white;\n      font-size: 1.3em;\n    }\n    \n    .selected.selector-color {\n      transform: rotate(360deg);\n    }\n    \n    .selector-color input {\n      width: 30px;\n      background-size: cover;\n      position: absolute;\n      height: 30px;\n      top: 5px;\n      left: 5px;\n      box-shadow: inset rgb(0 0 0 / 50%) 0px 0px 12px;\n      transition: 1s;\n    }\n    \n    .selected.selector-color input {\n      width: 40px;\n      height: 40px;\n      top: 0px;\n      left: 0px;\n    }\n    \n    .contiene-descripcion > table > tbody > tr > td > div > img {\n      max-width: 100%;\n      height: auto;\n    }"],"sourceRoot":""}]);
// Exports
